...
XXX. Each budget has a year, as well as a way to read that data
XXX. A budget can list all of its departments
XXX. A budget can list all departments with expenses less than $500
